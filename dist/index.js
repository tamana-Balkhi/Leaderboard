...
/* harmony import */ var _modules_addScore_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _modules_scoretable_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);




document.querySelector('main').innerHTML += _modules_addScore_js__WEBPACK_IMPORTED_MODULE_0__["default"];
document.querySelector('main').innerHTML += _modules_scoretable_js__WEBPACK_IMPORTED_MODULE_1__["default"];
...
/* harmony export */ });
const addScoresC = `<div class="add-score-container container">
        <h2 class="table-title">Add your score</h2>
        <form class="form" action="#">
          <input type="text" name="name" id="input-name" placeholder="Your name" required>
          <input type="number" name="score" id="input-score" placeholder="Your score" required>
          <button type="submit">Submit</button>
        </form>
      </div>`;

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addScoresC);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const sTable = `<div class="recent-scores-container container">
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (sTable);
